...
//    console.log(location.value)
  $.post(url, {
      ...
      estPrice.innerHTML = "<h2>" + data.estimated_home_price.toString() + " Lakh</h2>";
      console.log(status);
  });
}
...
function onPageLoad() {
  ...
  var areaUrl = "http://127.0.0.1:5000/get_area_names";
  ...
  // Get area names
  $.get(areaUrl, function(data, status) {
    console.log("got response for get_area_names request");
    if (data) {
      var areas = data.area_names;
